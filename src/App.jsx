...
function makeTask(skillKey) {
  ...
  if (skillKey === "comprehension") {
    const bank = [
      ...
      { text: "Балалар ойнады. Ойын қызық болды.", q: "Не қызық болды?", correct: "Ойын", options: ["Ойын", "Кітап", "Сабақ"] },
      { text: "Күн шықты. Аспан ашық болды.", q: "Аспан қандай болды?", correct: "Ашық", options: ["Ашық", "Бұлтты", "Қараңғы"] },
      { text: "Ата ертегі айтты. Балалар тыңдады.", q: "Ата не айтты?", correct: "Ертегі", options: ["Ертегі", "Өлең", "Жұмбақ"] },
      { text: "Ана нан пісірді. Нан дәмді болды.", q: "Нан қандай болды?", correct: "Дәмді", options: ["Дәмді", "Қатты", "Суық"] },
      { text: "Мұғалім сабақ берді. Оқушылар тыңдады.", q: "Оқушылар не істеді?", correct: "Тыңдады", options: ["Тыңдады", "Ұйықтады", "Ойнады"] },
    ];

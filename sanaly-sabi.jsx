...
// false қайтарады да, шақырушы TTS-ке көшеді.
function playRealAudio(url) {
  return new Promise((resolve) => {
    try {
      ...
      // Желі баяу болса, ұзақ күтіп қалмау үшін шектеу қоямыз.
...
const SOUND_TEXT = {
  А: "ааа", Ә: "әәә", Е: "еее", Ы: "ыыы", І: "ііі", О: "ооо", Ө: "өөө",
  Ұ: "ұұұ", Ү: "үүү", Э: "эээ", Ю: "юю", Я: "яя", И: "ии", У: "уу",
  М: "ммм", Н: "ннн", Ң: "ыңың", Л: "ллл", Р: "ррр",
  С: "ссс", Ш: "шшш", Ж: "жжж", З: "ззз", Ф: "ффф", В: "ввв", Х: "ххх", Һ: "hhh",
  ...
  return (
    <Screen>
      ...
      <div className="flex-1 mt-6 relative">
        <TaskCard task={task} onAnswer={handleAnswer} wrongStreak={wrongStreak} />
        {feedback && (
          <div
